 ...
 *  $Rev: 12190 $ | $Date: 2013-11-11 17:57:57 +0000 (Mon, 11 Nov 2013) $| $Author: hsilva $ | SW-FMECA 5, 6, 7 and 19
 *
 **/
...
#include <rtems/system.h>
   ...
   typedef enum
   {
      ...
      RTEMS_INVALID_OP_WITH_SEMAPHORES = 32 , /* invalid operation with semaphores */
      RTEMS_DEADLINE_GT_PERIOD = 33 , /* deadline surpasses period */
      RTEMS_INVALID_DEADLINE_STATE = 34 , /* RTEMS has an invalid deadline state */
      RTEMS_INVALID_DEADLINE = 35 /* deadline is set with invalid value */
   } rtems_status_code;
