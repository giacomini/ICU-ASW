...
#define rtems_interrupt_is_in_progress() \
   ...
   /**
    *  @brief rtems_interrupt_is_masked
    *
    *  This macro returns TRUE if the interrupt number passed as argument is
    *  currently masked and FALSE otherwise.
    */
#define rtems_interrupt_is_masked(_source) \
    BSP_interrupt_is_masked(_source)

   /**
    *  @brief rtems_mask_interrupt
    *
    *  This macro masks a specific interrupt, passed as macro argument.
    */
#define rtems_mask_interrupt(_source) \
    BSP_mask_interrupt(_source)

   /**
    *  @brief rtems_unmask_interrupt
    *
    *  This macro un-masks a specific interrupt, passed as macro argument.
    */
#define rtems_unmask_interrupt(_source) \
