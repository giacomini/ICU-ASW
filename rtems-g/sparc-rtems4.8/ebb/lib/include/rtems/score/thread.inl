 ...
 *  $Rev: 10200 $ | $Date: 2011-05-25 12:26:55 +0100 (Wed, 25 May 2011) $| $Author: hsilva $ | SPR 2961 - Deferred FPU switch
 *
 **/
...
{
   /* calculate the heir thread based on the highest priority ready thread */
   _Thread_Heir = (Thread_Control *) _Thread_Ready_chain[ _Priority_Get_highest() ].first;
}

/**
 *  @brief Checks if the fp context is currently loaded in the fpu
 *
