 ...
 *  11746   | 19/03/2013  | hsilva       | SPR 3065
 *  11818   | 07/05/2013  | hsilva       | SPR 3066
...
#include <rtems/score/watchdog.h>
   ...
   /**
    *  @brief define the way in which the entry point for a
   ...
   typedef struct
   {
      ...
      void *stack;
      /**
       * @brief stack footer area address.
       */
      uint32_t *stack_footer;
      /**
       * @brief stack header area address.
       */
      uint32_t *stack_header;
