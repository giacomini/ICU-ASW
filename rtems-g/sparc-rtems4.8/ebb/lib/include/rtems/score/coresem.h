 ...
 *  $Rev: 12190 $ | $Date: 2013-11-11 17:57:57 +0000 (Mon, 11 Nov 2013) $| $Author: hsilva $ | SPR 2819
 *
 **/
...
#include <rtems/score/watchdog.h>
   ...
   typedef enum
   {
      ...
      /**
       *  @brief This status indicates that a thread with a semaphore with priority
       *  ceiling/inheritance is trying to obtain a semaphore with priority
       *  inheritance/ceiling.
       */
      CORE_SEMAPHORE_MUTEX_UNSATISFIED_WAIT
